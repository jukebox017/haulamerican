  ...
  return (
    <div id="estimate-container">
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div style={{ display: 'grid', grid: 'auto-flow / 205px 205px 2fr' }}>
          <button
            type="button"
            className={`service-type ${fiveOrLess === 'true' ? 'selected' : ''}`}
            style={{ width: '200px' }}
          ...
          <button
            type="button"
            className={`service-type ${fiveOrLess === 'false' ? 'selected' : ''}`}
            style={{ width: '200px' }}
